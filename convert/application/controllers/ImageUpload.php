...
*/
class imageUpload extends User_Controller
{
	...
	const ROOT_PATH = './';
	const FAIL_WRITE_DATA = '文件上传失败';
	//没有数据流
	const NO_STREAM_DATA = '上传数据不能为空';
	//图片类型不正确
	const NOT_CORRECT_TYPE = '图片格式不合法';
	//不能创建文件
	const CAN_NOT_CREATE_FILE = '创建文件失败';
	//上传图片名称
	public $image_name;
	//图片保存名称
	public $save_name;
	...
	public function __construct($save_name, $save_dir) {
		...
		$this->save_dir =$_SERVER['DOCUMENT_ROOT'].'/jcrop/avatars';
		//创建文件夹
