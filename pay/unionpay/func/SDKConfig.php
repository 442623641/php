...
// 签名证书路径
const SDK_SIGN_CERT_PATH ='/700000000000001_acp.p12';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '000000';
// 密码加密证书（这条用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = '/verify_sign_acp.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = 'D:/Apache24/htdocs/Web/pay/unionpay/func/';
...
// 前台通知地址 (商户自行配置通知地址)
//const SDK_FRONT_NOTIFY_URL ='/UserCenter/Charge/';
const SDK_FRONT_NOTIFY_URL ='http://www.xkbm.com:82/pay/unionpay/FrontReceive.php';
// 后台通知地址 (商户自行配置通知地址)
const SDK_BACK_NOTIFY_URL ='http://www.xiangw.com.cn/pay/unionpay/BackReceive.php';
//文件下载目录 
...
const SDK_MERID='777290058115509';
